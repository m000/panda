...
#define MAX_SYSCALL_NO 376
#define MAX_SYSCALL_GENERIC_NO 376
...
static syscall_argtype_t argt_7[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_7[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
...
static syscall_argtype_t argt_18[] = {SYSCALL_ARG_STR, SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_22[] = {SYSCALL_ARG_STR};
...
static syscall_argtype_t argt_28[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_48[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_59[] = {SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_76[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_82[] = {SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_84[] = {SYSCALL_ARG_STR, SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_89[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_89[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_90[] = {SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_101[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_S32};
...
static syscall_argtype_t argt_109[] = {SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_113[] = {SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_123[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
...
static syscall_argtype_t argt_217[] = {SYSCALL_ARG_STR, SYSCALL_ARG_STR};
static uint8_t argsz_217[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_218[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_STR};
static uint8_t argsz_218[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_219[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_S32};
static uint8_t argsz_219[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_220[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
...
static syscall_argtype_t argt_244[] = {SYSCALL_ARG_PTR};
static uint8_t argsz_244[] = {sizeof(uint32_t)};
static syscall_argtype_t argt_245[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_247[] = {SYSCALL_ARG_U32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_247[] = {sizeof(uint32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_248[] = {SYSCALL_ARG_U32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR};
static uint8_t argsz_248[] = {sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_249[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_249[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_250[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U64, SYSCALL_ARG_U32, SYSCALL_ARG_S32};
static uint8_t argsz_250[] = {sizeof(int32_t), sizeof(uint64_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_252[] = {SYSCALL_ARG_S32};
static uint8_t argsz_252[] = {sizeof(int32_t)};
static syscall_argtype_t argt_253[] = {SYSCALL_ARG_U64, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_253[] = {sizeof(uint64_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_254[] = {SYSCALL_ARG_S32};
static uint8_t argsz_254[] = {sizeof(int32_t)};
static syscall_argtype_t argt_255[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR};
static uint8_t argsz_255[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_256[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32, SYSCALL_ARG_S32};
...
static syscall_argtype_t argt_258[] = {SYSCALL_ARG_PTR};
static uint8_t argsz_258[] = {sizeof(uint32_t)};
static syscall_argtype_t argt_259[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_259[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_260[] = {SYSCALL_ARG_U32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_260[] = {sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_261[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
...
static syscall_argtype_t argt_265[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_265[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_266[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_266[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_267[] = {SYSCALL_ARG_U32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_267[] = {sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_268[] = {SYSCALL_ARG_STR, SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_268[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_269[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_269[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_270[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_270[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t)};
static syscall_argtype_t argt_271[] = {SYSCALL_ARG_STR, SYSCALL_ARG_PTR};
static uint8_t argsz_271[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_272[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U64, SYSCALL_ARG_U64, SYSCALL_ARG_S32};
static uint8_t argsz_272[] = {sizeof(int32_t), sizeof(uint64_t), sizeof(uint64_t), sizeof(int32_t)};
static syscall_argtype_t argt_274[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_274[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_275[] = {SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_275[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_276[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_276[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_277[] = {SYSCALL_ARG_STR, SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_277[] = {sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_278[] = {SYSCALL_ARG_STR};
static uint8_t argsz_278[] = {sizeof(uint32_t)};
static syscall_argtype_t argt_279[] = {SYSCALL_ARG_U32, SYSCALL_ARG_STR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_279[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_280[] = {SYSCALL_ARG_U32, SYSCALL_ARG_STR, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_280[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_281[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_281[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_282[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_282[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_283[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_283[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_284[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32, SYSCALL_ARG_PTR};
static uint8_t argsz_284[] = {sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_286[] = {SYSCALL_ARG_STR, SYSCALL_ARG_STR, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_286[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_287[] = {SYSCALL_ARG_STR, SYSCALL_ARG_STR, SYSCALL_ARG_STR, SYSCALL_ARG_U32};
static uint8_t argsz_287[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_288[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_288[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_289[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_289[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t)};
static syscall_argtype_t argt_290[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_290[] = {sizeof(int32_t), sizeof(int32_t)};
static syscall_argtype_t argt_291[] = {};
static uint8_t argsz_291[] = {};
static syscall_argtype_t argt_292[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_U32};
...
static syscall_argtype_t argt_294[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_294[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_295[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32, SYSCALL_ARG_U32};
static uint8_t argsz_295[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_296[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_U32};
static uint8_t argsz_296[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_297[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_297[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_298[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_S32};
static uint8_t argsz_298[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_299[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_PTR};
static uint8_t argsz_299[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_300[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_300[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_301[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32};
static uint8_t argsz_301[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_302[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32, SYSCALL_ARG_STR};
static uint8_t argsz_302[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_303[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32};
static uint8_t argsz_303[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_304[] = {SYSCALL_ARG_STR, SYSCALL_ARG_S32, SYSCALL_ARG_STR};
static uint8_t argsz_304[] = {sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_305[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_305[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_306[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_U32};
static uint8_t argsz_306[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_307[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32};
static uint8_t argsz_307[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_308[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_308[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_309[] = {SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_309[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_310[] = {SYSCALL_ARG_U32};
static uint8_t argsz_310[] = {sizeof(uint32_t)};
static syscall_argtype_t argt_311[] = {SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_311[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_312[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_312[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_313[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_313[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_314[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U64, SYSCALL_ARG_U64, SYSCALL_ARG_U32};
static uint8_t argsz_314[] = {sizeof(int32_t), sizeof(uint64_t), sizeof(uint64_t), sizeof(uint32_t)};
static syscall_argtype_t argt_315[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_315[] = {sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_316[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_316[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_317[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_317[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_318[] = {SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_318[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_319[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_319[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_320[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
...
static syscall_argtype_t argt_322[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_322[] = {sizeof(int32_t), sizeof(int32_t)};
static syscall_argtype_t argt_323[] = {SYSCALL_ARG_U32};
static uint8_t argsz_323[] = {sizeof(uint32_t)};
static syscall_argtype_t argt_324[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_U64, SYSCALL_ARG_U64};
static uint8_t argsz_324[] = {sizeof(int32_t), sizeof(int32_t), sizeof(uint64_t), sizeof(uint64_t)};
static syscall_argtype_t argt_325[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_325[] = {sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_326[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR};
static uint8_t argsz_326[] = {sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_327[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_S32};
static uint8_t argsz_327[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_328[] = {SYSCALL_ARG_U32, SYSCALL_ARG_S32};
static uint8_t argsz_328[] = {sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_329[] = {SYSCALL_ARG_S32};
static uint8_t argsz_329[] = {sizeof(int32_t)};
static syscall_argtype_t argt_330[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_S32};
static uint8_t argsz_330[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_331[] = {SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
...
static syscall_argtype_t argt_333[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_333[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_334[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_334[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_335[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR};
static uint8_t argsz_335[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_336[] = {SYSCALL_ARG_PTR, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_U32};
static uint8_t argsz_336[] = {sizeof(uint32_t), sizeof(int32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_337[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_337[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_338[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_338[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_339[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_U64, SYSCALL_ARG_S32, SYSCALL_ARG_STR};
static uint8_t argsz_339[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint64_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_340[] = {SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_340[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_341[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_341[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_342[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_342[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_343[] = {SYSCALL_ARG_U32, SYSCALL_ARG_PTR};
static uint8_t argsz_343[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_344[] = {SYSCALL_ARG_S32};
static uint8_t argsz_344[] = {sizeof(int32_t)};
static syscall_argtype_t argt_345[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_345[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_346[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_346[] = {sizeof(int32_t), sizeof(int32_t)};
static syscall_argtype_t argt_347[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_347[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_348[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_348[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_349[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_349[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_350[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32};
static uint8_t argsz_350[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_351[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_351[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_352[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_352[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_353[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_U32};
static uint8_t argsz_353[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_354[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_STR};
static uint8_t argsz_354[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_355[] = {SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32};
static uint8_t argsz_355[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_356[] = {SYSCALL_ARG_STR, SYSCALL_ARG_U32};
static uint8_t argsz_356[] = {sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_357[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_357[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_358[] = {SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_STR, SYSCALL_ARG_STR, SYSCALL_ARG_S32};
static uint8_t argsz_358[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_359[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_359[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t)};
static syscall_argtype_t argt_360[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_PTR};
static uint8_t argsz_360[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_361[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_361[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_362[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_362[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_363[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_363[] = {sizeof(int32_t), sizeof(int32_t)};
static syscall_argtype_t argt_364[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_364[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_365[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_PTR};
static uint8_t argsz_365[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_366[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_S32, SYSCALL_ARG_STR, SYSCALL_ARG_S32};
static uint8_t argsz_366[] = {sizeof(int32_t), sizeof(int32_t), sizeof(int32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_367[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_367[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_368[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_368[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_369[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_S32};
static uint8_t argsz_369[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
static syscall_argtype_t argt_370[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_370[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_371[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_PTR, SYSCALL_ARG_PTR};
static uint8_t argsz_371[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_372[] = {SYSCALL_ARG_S32, SYSCALL_ARG_PTR, SYSCALL_ARG_U32};
static uint8_t argsz_372[] = {sizeof(int32_t), sizeof(uint32_t), sizeof(uint32_t)};
static syscall_argtype_t argt_373[] = {SYSCALL_ARG_S32, SYSCALL_ARG_S32};
static uint8_t argsz_373[] = {sizeof(int32_t), sizeof(int32_t)};
...
static syscall_argtype_t argt_376[] = {SYSCALL_ARG_U32, SYSCALL_ARG_U32, SYSCALL_ARG_S32};
static uint8_t argsz_376[] = {sizeof(uint32_t), sizeof(uint32_t), sizeof(int32_t)};
